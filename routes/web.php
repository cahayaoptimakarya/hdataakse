...
Route::middleware(['auth', 'verified', 'menu.permission'])->prefix('admin')->as('admin.')->group(function () {
    ...
    Route::prefix('keuangan')->as('keuangan.')->group(function () {
        ...
        Route::delete('/jurnal-umum', [JurnalUmumImportController::class, 'destroyAll'])->name('jurnal-umum.destroy');
        ...
        Route::get('/laporan/export-divisi', [LaporanJurnalUmumController::class, 'exportDivisi'])->name('laporan.export-divisi');
